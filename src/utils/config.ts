...
export interface AplayerOptionsConfig {
  fixed?: boolean;
  autoplay?: boolean;
  loop?: "all" | "one" | "none";
  order?: "list" | "random";
...
export interface PlayerConfig {
  enable: boolean;
  position: "before_sidebar" | "after_sidebar" | "after_widget";
...
export const BEAUDAR = typedConfig.beaudar;
...
export const PLAYER_HAS_SOURCE =
  PLAYER.enable &&
  PLAYER.aplayer.enable &&
  (PLAYER.meting.enable ||
    (PLAYER.aplayer.options.audio?.length ?? 0) > 0);
